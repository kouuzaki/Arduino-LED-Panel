...
// ============================================
// Arduino Mega 2560 Pin Mapping for HUB08 Panel:
//
...
//
// Control Pins:
//   - CLOCK_PIN:  D24 (Shift clock / CLK)
//   - LATCH_PIN:  D25 (Latch enable / LAT)
//   - ENABLE_PIN: D3 (Output enable / OE - active LOW) ⚡ MUST BE PWM PIN!
//
...
//   - Protocol: HUB08 (common for P4, P5, P6 indoor panels)
//
// IMPORTANT:
//   - ENABLE_PIN MUST be a PWM-capable pin for brightness control!
//   - Arduino Mega PWM pins: 2-13, 44-46
//   - Power: Use external 5V PSU (min 2A per panel)
//   - Ground: Common GND between Arduino, PSU, and Panel
//
// ============================================
